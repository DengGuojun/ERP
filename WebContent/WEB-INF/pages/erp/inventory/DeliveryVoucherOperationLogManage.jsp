	...
	<div class="article_tit">
		...
		<div class="modify_form">
			...
			<p>
				...
				DataLogContentConvertor helper = new DataLogContentConvertor(DeliveryVoucherLogDisplayConfig.CONFIG_VALUE_MAP);
		...
		<div class="div_center">
		     <%if(mode.equals("po")){ %>
			 <input type="button" name="button" id="button" value="返回" onclick="javascript:location.href='DeliveryVoucherOperationLogList.do?dvId=<%=dvId%>&readOnly=<%=readOnly%>&dvType=<%=dvType%>&wareType=<%=wareType%>&mode=<%=mode%>'">
		     <%}else{ %>
		     <input type="button" name="button" id="button" value="返回" onclick="javascript:location.href='DeliveryVoucherOperationLogList.do?mode=<%=mode%>'">
		     <%} %>
		</div>
</body>
</html>