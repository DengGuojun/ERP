	...
	<div class="article_tit">
		...
		<div class="modify_form">
			...
			<p>
				...
				DataLogContentConvertor helper = new DataLogContentConvertor(BomInfoLogDisplayConfig.CONFIG_VALUE_MAP);
		...
		<div class="div_center">
			 <input type="button" name="button" id="button" value="返回" onclick="javascript:location.href='BomInfoOperationLogList.do'">
		</div>
</body>
</html>