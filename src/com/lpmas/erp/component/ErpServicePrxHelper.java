...
public final class ErpServicePrxHelper extends Ice.ObjectPrxHelperBase implements ErpServicePrx
{
    ...
    public Ice.AsyncResult begin_rpc(String method, String params, Callback_ErpService_rpc __cb)
    {
        return begin_rpc(method, params, null, false, false, __cb);
    }

    public Ice.AsyncResult begin_rpc(String method, String params, java.util.Map<String, String> __ctx, Callback_ErpService_rpc __cb)
    {
        return begin_rpc(method, params, __ctx, true, false, __cb);
    }
    ...
    {
        com.lpmas.erp.component.ErpServicePrx __proxy = (com.lpmas.erp.component.ErpServicePrx)__result.getProxy();
        String __ret = null;
        try
        {
    ...
    public static ErpServicePrx checkedCast(Ice.ObjectPrx __obj)
    {
        return checkedCastImpl(__obj, ice_staticId(), ErpServicePrx.class, ErpServicePrxHelper.class);
    }

    public static ErpServicePrx checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        return checkedCastImpl(__obj, __ctx, ice_staticId(), ErpServicePrx.class, ErpServicePrxHelper.class);
    }

    public static ErpServicePrx checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        return checkedCastImpl(__obj, __facet, ice_staticId(), ErpServicePrx.class, ErpServicePrxHelper.class);
    }

    public static ErpServicePrx checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        return checkedCastImpl(__obj, __facet, __ctx, ice_staticId(), ErpServicePrx.class, ErpServicePrxHelper.class);
    }

    public static ErpServicePrx uncheckedCast(Ice.ObjectPrx __obj)
    {
        return uncheckedCastImpl(__obj, ErpServicePrx.class, ErpServicePrxHelper.class);
    }

    public static ErpServicePrx uncheckedCast(Ice.ObjectPrx __obj, String __facet)
    {
        return uncheckedCastImpl(__obj, __facet, ErpServicePrx.class, ErpServicePrxHelper.class);
    }

    public static final String[] __ids =
    {
        "::Ice::Object",
        "::com::lpmas::erp::component::ErpService"
    };
    ...
    public static void __write(IceInternal.BasicStream __os, ErpServicePrx v)
    {
        __os.writeProxy(v);
    }

    public static ErpServicePrx __read(IceInternal.BasicStream __is)
    {
        Ice.ObjectPrx proxy = __is.readProxy();
        if(proxy != null)
        {
            ErpServicePrxHelper result = new ErpServicePrxHelper();
