...
public class MaterialPoItemDisplayBusinessImpl extends PurchaseOrderItemDisplayBusiness {

	@Override
	public String getDetailDisplayStr(int poId, Boolean isModify) {
		// 显示物料采购明细
		String templeteName = "materialPoDetailDisplay.html";
		...
		for (PurchaseOrderItemBean bean : itemList) {
			typeIdList.add(bean.getWareType());
		}
