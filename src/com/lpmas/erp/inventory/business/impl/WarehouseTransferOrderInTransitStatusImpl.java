...
public class WarehouseTransferOrderInTransitStatusImpl implements WarehouseTransferOrderStatus {

	private WarehouseTransferOrderInfoBean bean;

	public WarehouseTransferOrderInTransitStatusImpl(WarehouseTransferOrderInfoBean bean) {
		this.bean = bean;
	}
