...
public class ProductItemDeliveryVoucherItemDisplayImpl extends DeliveryVoucherItemDisplayBusiness {

	@Override
	public String getDeliveryVoucherDetailDisStr(int dvId, int sourceType, int sourceOrderId, Boolean isModify) {
		String templeteName = "productDvDetailDisplay.html";
		...
		for (Integer id : wareIdList) {
			ProductItemBean productItemBean = client.getProductItemByKey(id);
			itemDetailMap.put(String.valueOf(id), productItemBean);
		}
