...
public class WarehouseTransferOrderApprovedStatusImpl implements WarehouseTransferOrderStatus {

	private WarehouseTransferOrderInfoBean bean;

	public WarehouseTransferOrderApprovedStatusImpl(WarehouseTransferOrderInfoBean bean) {
		this.bean = bean;
	}
