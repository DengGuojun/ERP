...
/**
 * Servlet implementation class WarehouseVoucherOperationLogManage
 */
@WebServlet("/erp/WarehouseVoucherOperationLogManage.do")
public class WarehouseVoucherOperationLogManage extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public WarehouseVoucherOperationLogManage() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 请求转发
		RequestDispatcher rd = request.getRequestDispatcher(InventoryConsoleConfig.INVENTORY_PAGE_PATH + "WarehouseVoucherOperationLogManage.jsp");
